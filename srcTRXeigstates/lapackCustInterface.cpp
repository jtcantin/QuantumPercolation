...
void dsyevrEigstatesInterface(double* Hami, int N, int* numEigvals, double* eigvals, double* eigStateMatrix)
{
    ...
    //I compared the below to the results from dstevr, and
    info = LAPACKE_dsyevr(LAPACK_COL_MAJOR,'V','A','U',N_l,Hami,lda,dummy_int,dummy_int,dummy_int,dummy_int,abstol,&numEval,eigvals,eigStateMatrix,ldz,isuppz);
