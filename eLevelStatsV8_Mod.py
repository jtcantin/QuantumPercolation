...
#DON'T USE THIS ONE, IT IS FOR SPECIAL PURPOSES ONLY!!!!
...
#    binnedData, bin_edges = np.histogram(spacingsNormalized, bins=nBins,density=True)
    binnedData, bin_edges = np.histogram(spacingsNormalized, bins=nBins,density=True,range=(0,20))
    ...
    #Bin the data
    binnedDataGB, bin_edgesGB = np.histogram(spacingsNormalizedGB, bins=nBins,density=True,range=(0,20))
    ...
    #Bin the data
    binnedDataGBNE, bin_edgesGBNE = np.histogram(spacingsNormalizedGB, bins=nBins,density=True,range=(0,30))
