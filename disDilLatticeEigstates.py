#
#  disDilLatticeEigstates.py
#
#
# Created by Joshua Tyler Cantin on 2015-05-28.
#
#To run: python disDilLatticeEigstates.py N occupationArrayFilename onsiteEnergyArrayFilename
...
eigvecFilename = occupationArrayFilename[:-4]+"_eigvecs.txt"
eigvecFile = open(eigvecFilename,'w')
eigvecFile.write("# Site label, C_1, C_2, ... C_N where _? refers to eigenstate label.\n")
